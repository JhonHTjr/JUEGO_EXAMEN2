...
public class controlador implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if( this.juego.ganador()== 1 )
            ...
            mensaje(" 'PUNTO PARA NADIE' ");
    }

    
    private void mensaje(String s)
    {
           int seleccion = JOptionPane.showOptionDialog(null,"GANÓ EL JUGADOR " + s + "\n ¿QUE DESEA HACER AHORA?", "JUEGO DE JHON TERMINADO",
                        JOptionPane.YES_NO_CANCEL_OPTION,
                        JOptionPane.QUESTION_MESSAGE,
                        null,    
                       new Object[] { "   DESEA JUGAR OTRA VES?   ", "   SALIR DEL PROGRAMA   " },
                       "Jugar otra vez");
